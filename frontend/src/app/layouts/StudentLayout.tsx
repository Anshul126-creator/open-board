...
import { User, DollarSign, FileText, LogOut, Menu } from 'lucide-react';
...
export function StudentLayout() {
  ...
  const navItems = [
    { to: '/student', icon: User, label: 'My Profile', end: true },
    { to: '/student/fees', icon: DollarSign, label: 'Fee Payment' },
    { to: '/student/results', icon: FileText, label: 'Results & Documents' }
  ];
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      <div className="border-b border-gray-200 p-6">
        <h1 className="text-xl">Student Panel</h1>
